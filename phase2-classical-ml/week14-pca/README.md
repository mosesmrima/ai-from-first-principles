...
**Resources:** StatQuest (PCA); ISLR ch. 6 & 12; MML book §10.

**Checkpoint:** explain what the principal components are and how PCA relates to SVD.
Mark done: `uv run python track.py done week14`.
