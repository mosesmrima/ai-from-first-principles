...
**Resources:** StatQuest (decision trees); ISLR ch. 8.

**Checkpoint:** explain entropy vs. Gini and how the tree decides where to split, plus why
unconstrained trees overfit. Mark done: `uv run python track.py done week11`.
