...
**Resources:** StatQuest (k-means, naive Bayes); ISLR ch. 12.

**Checkpoint:** explain why k-means can land in a bad local optimum and how init (e.g. k-means++)
helps. Mark done: `uv run python track.py done week13`.
