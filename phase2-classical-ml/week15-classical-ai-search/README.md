...
**Resources:** Berkeley CS188 (search, heuristics) or Stanford CS221; value iteration as a stretch.

**Checkpoint:** explain what makes a heuristic *admissible*, and why an admissible heuristic
makes A\* find optimal paths. Mark done: `uv run python track.py done week15`.
